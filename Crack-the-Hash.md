...
The main body of the application initiates a while loop. IF there is a deficiency, is that there is no point in the application where the loop is ended by setting teh value of the while to False. That's a matter of prefernece and cleanliness. Not necessarily functionality.
