...
- [Processes](#processes)
  ...
  - [pstree](#pstree)
  - [top](#top)
  - [Identifying Suspicious Parent-Child Process Relationships](#identifying-suspicious-parent-child-process-relationships)
  - [ps Questions](#ps-questions)
- [Cronjobs](#cronjobs)
  - [Example Cron Entry for Bob](#example-cron-entry-for-bob)
  - [Cron Configuration Files](#cron-configuration-files)
  - [Cron Execution Logs](#cron-execution-logs)
  - [Pspy](#pspy)
  - [Cronjobs Questions](#cronjobs-questions)
- [Services](#services)
  - [Enumerating Services](#enumerating-services)
  - [Investigating Service Processes and Binaries](#investigating-service-processes-and-binaries)
  - [Inspecting Service Configuration Files](#inspecting-service-configuration-files)
  - [Inspecting Service Logs](#inspecting-service-logs)
  - [SErvices Questions](#services-questions)
- [Autostart Scripts](#autostart-scripts)
  - [System-wide autostart scripts](#system-wide-autostart-scripts)
  - [User-specific autostart scripts](#user-specific-autostart-scripts)
  - [Identifying System Autostart Scripts](#identifying-system-autostart-scripts)
  - [Identifying User Autostart Scripts](#identifying-user-autostart-scripts)
  - [Autostart Script Questions](#autostart-script-questions)
- [Application Artefacts](#application-artefacts)
  - [Vim](#vim)
  - [Browser Artefacts](#browser-artefacts)
  - [Additional Artefacts](#additional-artefacts)
  - [Application Artefact Questions](#application-artefact-questions)
